    ...
    public function up()
    {
        ...
        DB::unprepared(<<<'SQL'
            ...
            BEGIN
                ...
                nombreBase, agente, created_at, updated_at,
                campaign_id, company_id, created_by, started)
                SELECT
                la.cedula,
                la.nombre,
                la.apellido1,
                ...
                (cedula, nombre, apellido1, apellido2,
                fechaNacimiento, tel1, tel2, email, edad,
                nombreBase, assign_to, created_at, updated_at,
                campaign_id, company_id, created_by, started)
                SELECT
                la.cedula,
                la.nombre,
                ...
                INSERT INTO bases_historico
                (campaign_id, nombreBase, user_id, cantidadRegistros, etapa, estado, created_at, updated_at)
                VALUES
                (p_campaign_id, p_nombreBase, p_myId, p_cantidadRegistros, p_etapa, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
