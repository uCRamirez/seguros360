    ...
    <a-drawer :width="drawerWidth" :open="visible" :closable="false" :centered="true"  :title="pageTitle" @ok="onSubmit">
        ...
        <template #footer>
            <div class="text-center" style="padding: 1%;">
                <a-button style="margin-right: 5px;" v-if="addEditType == 'add' && (permsArray.includes('admin') || permsArray.includes('forms_view'))" key="submit" type="primary" :loading="loading" @click="onSubmit">
                    <SaveOutlined />
                    {{ $t("common.create") }}
                </a-button>
                <a-button style="margin-right: 5px;" v-if="addEditType == 'edit' && (permsArray.includes('admin') || permsArray.includes('notes_edit'))" key="submit" type="primary" :loading="loading" @click="onSubmit">
                    <SaveOutlined />
                    {{ $t("common.update") }}
                </a-button>
        ...
        watch(() => props.visible, async newVal => {
            ...
            Object.assign(
                ...
                props.addEditType === "add" ? getEmptyVenta() : {},
                {
                    ...
                    nombre: props.leadInfo ? `${props.leadInfo.nombre} ${props.leadInfo.segundo_nombre} ${props.leadInfo.apellido1} ${props.leadInfo.apellido2}`:`${props.data.lead.nombre} ${props.data.lead.apellido1} ${props.data.lead.apellido2}`,
