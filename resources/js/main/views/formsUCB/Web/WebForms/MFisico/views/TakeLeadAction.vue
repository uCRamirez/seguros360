                                        ...
                                        <a-form layout="vertical" class="mt-10">
                                            <a-row :gutter="10">
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <a-select
                                                            v-model:value="crmState.client.lead_status.id"
                                                            show-search
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <a-select
                                                            v-model:value="crmState.client.estado_civil.id"
                                                            :placeholder="
                                                                $t(
                                                                    'common.select_default_text',
                                                                    [
                                ...
                                <a-tab-pane key="search_lead">
                                    ...
                                    <a-col :xs="24" :sm="24" :md="8" :lg="8">
                                        <div
                                            ...
                                            <a-button @click="clearSerchInformation" type="primary" style="margin-top: 10px;min-width: 130px;">{{$t('common.clear')}}</a-button>
                                            <a-button @click="clientToManage" :disabled="crmState.client.toManage === false" type="primary"
