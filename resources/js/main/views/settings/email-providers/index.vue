<template>
    <AdminPageHeader>
        <template #header>
            <a-page-header :title="$t(`menu.email_providers`)" class="p-0" />
        </template>
        <template #breadcrumb>
                ...
                <a-row :gutter="[16, 16]">
                    <a-col :xs="24" :sm="24" :md="12" :lg="10" :xl="10">
                        <a-space>
                            <template
                                v-if="
                                    permsArray.includes('email_providers_create') ||
                                    permsArray.includes('admin')
                                "
                            >
                                <a-button type="primary" @click="addItem">
                                    <PlusOutlined />
                                    {{ $t("email_provider.add") }}
                                </a-button>
                            </template>
                            <a-button
                                v-if="
                                    table.selectedRowKeys.length > 0 &&
                                    (permsArray.includes('email_providers_delete') ||
                                        permsArray.includes('admin'))
                                "
                                type="primary"
...
export default {
    ...
    setup() {
        ...
        onMounted(() => {
            ...
            crudVariables.langKey.value = "email_provider";
