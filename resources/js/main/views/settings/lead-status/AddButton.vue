<template>
    <div v-if="permsArray.includes('lead_status_create') || permsArray.includes('admin')">
        <a-tooltip
            v-if="tooltip"
            placement="topLeft"
            :title="$t('lead_status.add')"
        ...
        <AddEdit
            ...
            :formData="formData"
            :data="formData"
            :pageTitle="$t('lead_status.add')"
            :successMessage="$t('lead_status.created')"
        />
    </div>
</template>
<script>
