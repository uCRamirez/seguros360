                ...
                <a-card class="page-content-container mt-20 mb-20">
                    <a-form layout="vertical">
                        ...
                        <a-row :gutter="16">
                            ...
                            <a-col :xs="24" :sm="24" :md="6" :lg="6">
                                <a-form-item
                                    :label="$t('company.login_card_color')"
                                    name="login_card_color"
                                    :help="
                                        rules.login_card_color
                                            ? rules.login_card_color.message
                                            : null
                                    "
                                    :validateStatus="
                                        rules.login_card_color ? 'error' : null
                                    "
                                >
                                    <color-picker
                                        v-model:pureColor="
                                            formData.login_card_color
                                        "
                                        format="hex"
                                        useType="pure"
                                        v-model:gradientColor="loginCardColor"
                                    />
                                </a-form-item>
                            </a-col>
                        </a-row>
                        ...
                        <a-row :gutter="16">
                            ...
                            <a-col :xs="24" :sm="24" :md="12" :lg="12">
                                <a-form-item
                                    ...
                                    :help="
                                        rules.lang_id
                                            ? rules.lang_id.message
                                            : null
                                    "
                                    :validateStatus="
                                        rules.lang_id ? 'error' : null
                                    "
                                    class="required"
                                >
                                    <span style="display: flex">
...
export default {
    ...
    setup() {
        ...
        const { permsArray, appSetting, dayjsObject, appType, themeMode } =
            common();
        const { t } = useI18n();
        ...
        const loginCardColor = ref("#ffffff");
        ...
        const setFormData = () => {
            formData.value = {
                ...
                login_card_color: company.login_card_color,
