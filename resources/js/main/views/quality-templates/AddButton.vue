<template>
    <div
        v-if="
            permsArray.includes('notes_typification_create') ||
            permsArray.includes('admin')
        "
    >
        <template v-if="customType == 'menu'">
            <a-menu-item @click="showAdd" key="notes_typification">
                <template #icon>
                    <slot name="icon"></slot>
                </template>
                <slot></slot>
        ...
        <template v-else>
            <a-tooltip
                v-if="tooltip"
                placement="topLeft"
                :title="$t('notes_typification.add')"
        ...
        <AddEdit
            ...
            :formData="formData"
            :data="formData"
            :pageTitle="$t('notes_typification.add')"
            :successMessage="$t('notes_typification.created')"
        />
    </div>
</template>
<script>
