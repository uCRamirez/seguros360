    ...
    >
        <a-row :gutter="16">
            <a-col :xs="24" :sm="24" :md="24" :lg="24">
                ...
                >
                    <a-descriptions-item
                        v-if="data && data.x_lead_id"
                        :label="$t('uphone_calls.lead_id')"
                    >
                        {{ data.lead?.id }}
                    </a-descriptions-item>
                    <a-descriptions-item
                        v-if="data && data.x_campaign_id"
                        :label="$t('uphone_calls.campaign_id')"
                    >
                        {{ data.campaigns?.name }}
                    </a-descriptions-item>
                    ...
                    <a-descriptions-item :label="$t('uphone_calls.duration')">
                        {{ data.duration }}
                    </a-descriptions-item>
