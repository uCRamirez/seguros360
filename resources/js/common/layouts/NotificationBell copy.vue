        ...
        <template #overlay>
            <a-menu>
                ...
                <a-menu v-else>
                    ...
                    <a-menu-item v-for="note in notifications" :key="note.id" @click="handleClickNotification(note)"
                        ...
                        <span v-if="note.data.url" class="text-sm">
                            <a>
                                {{ $t('common.view') }}
                                {{ $t('common.link') }}
                            </a>
                    ...
                    <a-menu-item v-if="notifications.length != 0" key="mark-all" @click="markAllAsRead"
                        class="text-center">
    ...
    setup() {
        ...
        async function fetchNotifications() {
            ...
            try {
                ...
                notifications.value = res.data.unread
            } catch (err) {
                console.error(err)
