...
<body>
    ...
    <script>
        window.config = {
                ...
                'product_sample_file': "{{ asset('images/products.csv') }}",
                ...
                'customer_bases_sample_file': "{{ asset('images/customer_bases_sample_file.csv') }}",
                'wallet_bases_sample_file': "{{ asset('images/wallet_bases_sample_file.csv') }}",
                'payment_bases_sample_file': "{{ asset('images/payment_bases_sample_file.csv') }}",
