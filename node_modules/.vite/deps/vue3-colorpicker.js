import {
  merge_default
} from "./chunk-6ZAQKLJ5.js";
import "./chunk-CZ4MFB5L.js";
import {
  onClickOutside,
  tryOnMounted,
  useClipboard,
...
function hsvToRgb(h3, s3, v3) {
  ...
  s3 = bound01(s3, 100);
  v3 = bound01(v3, 100);
  var i3 = Math.floor(h3), f3 = h3 - i3, p3 = v3 * (1 - s3), q3 = v3 * (1 - f3 * s3), t3 = v3 * (1 - (1 - f3) * s3), mod = i3 % 6, r3 = [v3, q3, p3, p3, t3, v3][mod], g3 = [t3, v3, v3, q3, p3, p3][mod], b3 = [p3, p3, t3, v3, v3, q3][mod];
  return {
    r: r3 * 255,
    g: g3 * 255,
    b: b3 * 255
  ...
  setup(e2, { emit: t3 }) {
    ...
    const a3 = computed(() => {
      ...
      if (g3.stopPropagation(), o3.value && n3.value) {
        ...
        const h3 = Math.round((b3 - m3 / 2) / (d3.width - m3) * 100);
        i3.alpha = h3, l3.alpha = h3, t3("change", h3);
      }
    };
    return tryOnMounted(() => {
      const g3 = {
  ...
  setup(e2, { emit: t3 }) {
    ...
    const k2 = computed(() => {
      const b3 = tinycolor({
        ...
        s: c3.saturation,
        l: 0.8
      }).toPercentageRgbString(), h3 = tinycolor({
        h: c3.hue,
        s: c3.saturation,
        l: 0.6
      ...
      return {
        background: [
          `linear-gradient(to right, rgb(255, 255, 255), ${b3}, ${h3}, ${y3}, ${f3}, rgb(0, 0, 0))`,
          `-webkit-linear-gradient(left, rgb(255, 255, 255), ${b3}, ${h3}, ${y3}, ${f3}, rgb(0, 0, 0))`,
          `-moz-linear-gradient(left, rgb(255, 255, 255), ${b3}, ${h3}, ${y3}, ${f3}, rgb(0, 0, 0))`,
          `-ms-linear-gradient(left, rgb(255, 255, 255), ${b3}, ${h3}, ${y3}, ${f3}, rgb(0, 0, 0))`
        ]
      };
    }), p3 = () => {
      if (o3.value && n3.value) {
        const b3 = c3.lightness, h3 = o3.value.getBoundingClientRect(), y3 = n3.value.offsetWidth;
        return (1 - b3) * (h3.width - y3) + y3 / 2;
      }
      return 0;
    }, g3 = computed(() => ({
      left: p3() + "px",
      ...
      if (b3.stopPropagation(), o3.value && n3.value) {
        const h3 = o3.value.getBoundingClientRect(), y3 = n3.value.offsetWidth;
        let f3 = b3.clientX - h3.left;
        f3 = Math.max(y3 / 2, f3), f3 = Math.min(f3, h3.width - y3 / 2);
        const w3 = 1 - (f3 - y3 / 2) / (h3.width - y3);
...
var Nt2 = defineComponent({
  ...
  setup(e2, { emit: t3 }) {
    ...
    const { copy: o3, copied: n3, isSupported: i3 } = useClipboard(), l3 = ref("hex"), a3 = reactive({
      ...
      rgba: (h3 = e2.color) == null ? void 0 : h3.RGB,
  ...
  setup(e2, { emit: t3 }) {
    const o3 = e2.color || new A3(), n3 = reactive({
      ...
      if (e2.disableHistory)
        return;
      const h3 = n3.color.toRgbString();
      if (r3.value = r3.value.filter((y3) => !tinycolor.equals(y3, h3)), !r3.value.includes(h3)) {
        for (; r3.value.length > Ce2; )
          r3.value.pop();
        r3.value.unshift(h3);
      }
    }, 500), k2 = (h3) => {
      h3 === "advance" ? (i3.value = true, t3("advanceChange", true)) : (n3.color.hex = h3, t3("advanceChange", false));
    }, p3 = (h3) => {
      n3.color.alpha = h3;
    }, g3 = (h3) => {
      n3.color.hue = h3;
    }, d3 = (h3, y3) => {
      n3.color.saturation = h3, n3.color.brightness = y3;
    }, m3 = (h3) => {
      n3.color.lightness = h3;
    }, b3 = (h3) => {
      const f3 = h3.target.value.replace("#", "");
        ...
        createBaseVNode("div", wo2, [
          ...
          createBaseVNode("div", Bo, [
            ...
            createBaseVNode("div", {
              ...
              ref: "stopGradientRef",
              title: (h3 = e2.lang) == null ? void 0 : h3.end,
...
var qo = defineComponent({
  ...
  setup(e2, { emit: t3 }) {
    ...
    })), b3 = computed(() => n3.activeKey === "gradient" ? Me2.name : e2.pickerType === "fk" ? Pe2.name : Ve2.name), h3 = (s3) => {
      n3.isAdvanceMode = s3;
    }, y3 = computed(() => {
      const s3 = {
