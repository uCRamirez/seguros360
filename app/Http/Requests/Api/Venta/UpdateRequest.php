...
class UpdateRequest extends BaseRequest
{
	...
	public function rules()
	{
		...
		$rules = [
            ...
            'aplicaBeneficiariosAsist' => 'sometimes|nullable|boolean',
            'cantidadBeneficiariosAsist' => 'required|integer',
            'beneficiariosAsist' => 'sometimes|nullable|json',
            'productos' => 'sometimes|nullable|json',
